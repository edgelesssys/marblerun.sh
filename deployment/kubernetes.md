...
While Marbles build with [Ego](building-services/ego.md) perform in-process attestation, other frameworks, such as [Graphene](building-services/graphene.md), use out-of-process attestation.
...
We provide a [CLI](reference/cli.md) that facilitates the administrative tasks of Marblerun.
...
For more information see our [concepts section](getting-started/concepts.md)
...
For more information on the CLI see our [guide](reference/cli.md).
