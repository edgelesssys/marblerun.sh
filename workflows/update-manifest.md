...
## Requirements
In order to deploy an Update Manifest, you need to be in possession of a certificate/private key pair belonging to a user from the `Users` section of the original Manifest, as described in ["Defining a Manifest"](workflows/define-Manifest.md#manifestmarbles).
